...
def payments(request):
    ...
    # Send the order number and transaction ID back to the sendData method via JsonResponse
    data = {
...
def place_order(request, total=0, quantity=0):
    ...
    # If the cart count is less than or equal to zero, then redirect back to the shop
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Store the all the biling information inside the Order table
            data = Order()
